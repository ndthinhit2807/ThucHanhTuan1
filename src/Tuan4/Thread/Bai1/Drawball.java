 ...
 * @author ndthi
 */
public class Drawball extends javax.swing.JFrame {

    /** Creates new form Drawball */
    public Drawball() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Drawball.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
